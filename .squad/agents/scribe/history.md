...
- **Keyser ActiveTag Audit (2026-04-29T21:20:03Z):** Keyser audited ECS `ActiveTag` component viability post-raygui migration. Finding: `ActiveTag` is partially obsolete (gameplay shape buttons still use ECS hit path; menu/overlay now raygui-driven). Decision #168 merged to decisions.md; Orchestration and session logs created; inbox file deleted.
