...
- 2026-05-02T01:27:43.700-07:00: If switching to `main` is blocked by local edits, fetch first, verify `main` is an ancestor of `origin/main`, then fast-forward the local `main` ref with `git branch -f main origin/main` to avoid stashing or discarding user work.
