...
int main()
{
    ...
    while (!WindowShouldClose())    // Detect window close button or ESC key
    {
        ...
        BeginDrawing();
            ...
            //----------------------------------------------------------------------------------
            // Draw controls
            GuiLabel((Rectangle){ Anchor01.x + 210, Anchor01.y + 440, 300, 60 }, "GAME OVER");
            GuiLabel((Rectangle){ Anchor01.x + 210, Anchor01.y + 510, 300, 40 }, NULL);
            GuiLabel((Rectangle){ Anchor01.x + 210, Anchor01.y + 560, 300, 32 }, NULL);
            GuiLabel((Rectangle){ Anchor01.x + 110, Anchor01.y + 640, 500, 40 }, NULL);
