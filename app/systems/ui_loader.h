...
// Spawn UI element entities from a parsed screen JSON.
// Called by ui_navigation_system on every screen transition.
// Exposed here so regression tests can exercise malformed-schema paths
// without requiring real on-disk screen files.
