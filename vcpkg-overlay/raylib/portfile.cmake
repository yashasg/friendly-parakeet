if(VCPKG_TARGET_IS_LINUX)
    ...
    libxcursor-dev\n\
    libxi-dev\n\
These can be installed on Ubuntu systems via sudo apt install libgl1-mesa-dev libx11-dev libxrandr-dev libxinerama-dev libxcursor-dev libxi-dev"
    )
endif()
...
# ── Platform selection ───────────────────────────────────────
# Use the default Desktop (GLFW) backend.  GLFW is bundled inside
# raylib's source tree when USE_EXTERNAL_GLFW=OFF.
